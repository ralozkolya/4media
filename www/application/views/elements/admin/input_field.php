	...
	<div class="form-group">
		...
		<select class="form-control"
			...
			<?php foreach($value as $v): ?>
				...
				?>
				<?php if($v === $val): ?>
					<option value="<?php echo $v; ?>" selected><?php echo lang($v); ?></option>
				<?php else: ?>
					<option value="<?php echo $v; ?>"><?php echo lang($v); ?></option>
				<?php endif; ?>
			<?php endforeach; ?>
		</select>
	</div>
...
<?php elseif($type === 'submit'): ?>
	<div class="form-group">
		<input class="btn btn-primary" type="submit" value="<?php echo $value; ?>">
		<button class="btn btn-default back"><?php echo lang('back'); ?></button>
	</div>
